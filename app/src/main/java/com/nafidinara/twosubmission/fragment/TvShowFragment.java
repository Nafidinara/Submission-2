 ...
 */
public class TvShowFragment extends Fragment implements Adapter.OnItemClickListener {
    ...
    private void prepare() {
        titleData = getResources().getStringArray(R.array.title_tvShow);
        releaseData = getResources().getStringArray(R.array.release_tvShow);
        directorData = getResources().getStringArray(R.array.director_tvShow);
        runtimeData = getResources().getStringArray(R.array.runtime_tvShow);
        languageData = getResources().getStringArray(R.array.language_tvShow);
        scoreData = getResources().getStringArray(R.array.score_tvShow);
        genreData = getResources().getStringArray(R.array.genre_tvShow);
        storylineData = getResources().getStringArray(R.array.storyline_tvShow);
        imageData = getResources().obtainTypedArray(R.array.image_tvShow);
    }
